...
//  /* Infinite loop */
  for(;;)
  {
		...
		for (int i = 0; i<100;i++);
		HAL_SPI_TransmitReceive(&hspi1, txBuf+1, rxBuf, 1, 200);
		for (int i = 0; i<100;i++);
		HAL_SPI_TransmitReceive(&hspi1, txBuf+2, rxBuf, 1, 200);
		for (int i = 0; i<100;i++);
		HAL_SPI_TransmitReceive(&hspi1, txBuf+3, rxBuf, 1, 200);
		for (int i = 0; i<100;i++);
		HAL_SPI_TransmitReceive(&hspi1, txBuf+4, rxBuf, 1, 200);
